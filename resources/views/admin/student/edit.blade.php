                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{route('student.update',$data['row']->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                              @method('PUT')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="date_of_birth" type="date" class="form-control"  placeholder="dateofbirth" value="{{isset($data['row'])?$data['row']->date_of_birth:''}}">
                                    </div>
                                    <div class="form-group">
